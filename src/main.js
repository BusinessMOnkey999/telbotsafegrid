...
app.post("/api/users/telegram/info", async (req, res) => {
  console.log("Received request at /api/users/telegram/info with body:", req.body);
  try {
    const {
      userId,
      firstName,
    ...
    console.error("Error in /api/users/telegram/info:", error.message);
